...
const collector = new DecoratedClassBuilder<ControllerConfig,
    HandlerConfig,
    InjectedRequestParam>('dinoframe.http');
...
export const RequestParam = (name: string, params: Partial<RequestParamConfig> = {}) => {
